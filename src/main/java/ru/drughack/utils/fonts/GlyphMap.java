...
import ru.drughack.api.mixins.accesors.INativeImage;
...
public class GlyphMap {
    ...
    private void privateGenerate() {
        ...
        IntBuffer backingBuffer = MemoryUtil.memIntBuffer(((INativeImage) (Object) image).getPointer(), image.getWidth() * image.getHeight());
